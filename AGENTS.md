...
This file tells Codex how to operate inside this repository. Read it before doing any work.
...
Memory entries indicate John works in WSL2 with Claude Code, has Notion MCP integrations, and has done significant work on WordPress plugins and Claude Skills. Assume technical fluency. Don't over-explain WordPress or Codex basics. Do explain non-obvious architectural choices for this specific project.
